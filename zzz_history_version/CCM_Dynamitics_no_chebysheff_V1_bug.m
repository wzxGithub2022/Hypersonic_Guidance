...
%dynamics f，动力学
S   = 0.5026;                       %参考面积
rou = 1.225 * exp(-h*R0/7110);    %密度rou，需要多项式逼近
...
ddf1_y = [0,0,0,0,0];
ddf1_h = [0,0,0,0,0];
ddf1_v = [0,0,0,0,sin(alpha)];
ddf1_gama = [0,0,0,0,0];
ddf1_alpha = [0,0,sin(alpha),0,v*cos(alpha)];

ddf1_mat(h, v, gama, alpha) = [ddf1_y; ddf1_h; ddf1_v; ddf1_gama; ddf1_alpha];

ddf2_y = [0,0,0,0,0];
ddf2_h = [0,0,0,0,0];
ddf2_v = [0,0,0,0,cos(alpha)];
ddf2_gama = [0,0,0,0,0];
ddf2_alpha = [0,0,cos(alpha),0,-v*sin(alpha)];
