...
f_full = f_mat_value(:,:,i);        % 5*1 double，这个只是放在这里，没什么意义
...
lambda_range = linspace(0.5,1,10);              %线性插值，lambda的范围
...
%%
[sos_prob, w_lower, w_upper] = CCM_Hyper_Opt_linear(n,h_lim,v_lim,gama_lim,alpha_lim,state_base,...
                                f_full,df_full,ddf_full,condn,lambda,ccm_eps,return_metric,save_name);      %在这一步存好，sos_prob:sum of squares problem
...
df_mat(h, v, gama, alpha) = [df1;df2;df3;df4;df5];            %5*5，含x
